...
const char* ssid     = "xxxxxxx";     // WiFi SSID to connect to
const char* password = "xxxxxx"; // WiFi password needed for the SSID
const char* aDTU = "http://192.168.xxx.xxx/api/livedata/status?inv=138290780486.json"; // for the first OpenDTU ESP32
const char* bDTU = "http://192.168.xxx.xxx/api/livedata/status?inv=138291500324.json"; // for the second OpenDTU ESP32
const char* shelly = "http://192.168.xxx.xxx/status"; //  for the Shelly 3EM
const char* sensora = "http://192.168.xxx.xxx/getValues"; //  for the DHT22-WLAN-Sensor
const char* sensorb = "http://192.168.xxx.xxx/getValues"; //  for the BME1-WLAN-Sensor
// Use your own API key by signing up for a free developer account at https://openweathermap.org/
//String apikey       = "xxxxxxxxxxx";
String apikey         = "xxxxxxxxxxx";                  // See: https://openweathermap.org/  // It's free to get an API key, but don't take more than 60 readings/minute!
...
String LAT              = "52.11";                         // Home location Latitude
String LON              = "6.35";                         // Home location Longitude

String City             = "xxxxxxx";                      // Your home city See: http://bulk.openweathermap.org/sample/
