...
const char* ssid     = "XXXXXXXXXX";     // WiFi SSID to connect to
const char* password = "XXXXXXXXXX"; // WiFi password needed for the SSID
...
String LAT              = "51.31";                         // Home location Latitude
